...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<li class="nav-item">
		...
		<div class="bg-white py-2 collapse-inner rounded">
			...
			<a class="collapse-item" href="<?php echo ROOT ?>assets/admin/utilities-color.html">Colors</a>
			<a class="collapse-item" href="<?php echo ROOT ?>assets/admin/utilities-border.html">Borders</a>
			<a class="collapse-item" href="<?php echo ROOT ?>assets/admin/utilities-animation.html">Animations</a>
			<a class="collapse-item" href="<?php echo ROOT ?>assets/admin/utilities-other.html">Other</a>
		</div>
	</div>
</li>
<!-- Divider -->
